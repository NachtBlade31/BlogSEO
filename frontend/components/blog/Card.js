        ...
        <div className="lead pb-4">
            ...
            <div className="row">
                <div className="col-md-4">
                    <section>
                        <img className="img img-fluid" style={{ maxHeight: 'auto', width: '100%' }} src={`${API}/api/blog/photo/${blog.slug}`} alt={blog.title} />
                    </section>
                </div>
                <div className="col-md-8">
                    <section>
                        ...
                        <Link href={`/blogs/${blog.slug}`}>
                            ...
                            <a className="btn btn-primary pt-2">Show More</a></Link>
                    </section>
                </div>
            </div>
        </div>)
