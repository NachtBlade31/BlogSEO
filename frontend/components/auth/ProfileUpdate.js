    ...
    const handleSubmit = e => {
        ...
        update(token, userData).then(data => {
            if (data.error) {
                ...
                updateUser(data, () => {
                    setValues({ ...values, username: data.username, password: data.password, name: data.name, email: data.email, about: data.about, success: true, loading: false })
                })
        ...
        return (
            <form onSubmit={handleSubmit}>
                <div className="form-group">
                    <label className="btn btn-outline-info">Profile Picture
