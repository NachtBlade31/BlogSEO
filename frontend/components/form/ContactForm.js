...
const ContactForm = ({ authorEmail }) => {
    ...
    const { message, name, email, ent, buttonText, success, error } = values
        ...
        return (
            <form onSubmit={clickSubmit} className="pb-5">
                <div className="form-group">
                    ...
                    <textarea onChange={handleChange('message')} required type="text" className="form-control" value={message} rows="10"></textarea>
                </div>
